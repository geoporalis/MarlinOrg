...
#define STRING_CONFIG_H_AUTHOR "(GP, default config+adjustment)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Deltaborg"
...
#define DELTA
  ...
  #define DELTA_CARRIAGE_OFFSET 18.0 // mm 25??

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS (DELTA_SMOOTH_ROD_OFFSET-DELTA_EFFECTOR_OFFSET-DELTA_CARRIAGE_OFFSET)

  // Print surface diameter/2 minus unreachable space (avoid collisions with vertical towers).
  #define DELTA_PRINTABLE_RADIUS 70 //org 140
...
const bool Z_MIN_PROBE_ENDSTOP_INVERTING = true; // set to true to invert the logic of the endstop. //TODO
...
#define INVERT_Y_DIR false //TODO true in "old config" (maybe switch connector)
#define INVERT_Z_DIR false

// @section extruder

// For direct drive extruder v9 set to true, for geared extruder set to false.
#define INVERT_E0_DIR true //TODO should be ture
...
// For deltabots this means top and center of the Cartesian print volume.
  ...
  #define MANUAL_Z_HOME_POS 415 // For delta: Distance between nozzle and print surface after homing.
#endif
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 80, 109.9}//org, 760*1.1}  // default steps per unit for Kossel (GT2, 20 tooth)
#define DEFAULT_MAX_FEEDRATE          {500, 500, 500, 500}    // (mm/sec) //{300, 300, 300, 300} from old config
...
//
// TODO==> REMEMBER TO INSTALL U8glib to your ARDUINO library folder: http://code.google.com/p/u8glib/wiki/u8glib
