...
#define STRING_CONFIG_H_AUTHOR "(GP, default config+adjustment+uploadtest, 01a)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Rostockl"
...
#define MANUAL_Z_HOME_POS 4188888 // Distance between the nozzle to printbed after homing
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,80,109.9}  // default steps per unit for Ultimaker
