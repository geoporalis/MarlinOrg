...
#define STRING_CONFIG_H_AUTHOR "(GP, uploadtest, platformio 0.1b)" // Who made the changes.
...
#define MANUAL_Z_HOME_POS 415 // Distance between the nozzle to printbed after homing
